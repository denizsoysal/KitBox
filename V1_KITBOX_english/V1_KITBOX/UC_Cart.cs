...
namespace V1_KITBOX
{
    public partial class UC_Cart : UserControl
    {
        ...
        public UC_Cart(Order currentOrder)
        {
            ...
            {
                lbx_cabinets.Items.Add("Cabinet " + (i + 1).ToString());
        ...
        public void LoadData()
        {
            try
            {
                ...
                {
                    lbx_boxes.Items.Add("Level " + (j + 1).ToString());
                }
        ...
        private void lbx_boxes_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (doorColor == "Glass")
            {
                BoxDoorTypeValue.Text = "Glass";
                BoxDoorColorValue.Text = "Transparent";
            }
            else
            {
                BoxDoorTypeValue.Text = "Wood";
