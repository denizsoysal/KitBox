...
namespace WinForms_MySQL
{
    public static class function
    {
        ...
        public static String Return(string Select, string WhereName, string WhereValue)
        {
            ...
            connection = new MySql.Data.MySqlClient.MySqlConnection(connectionString);
            connection.Open();
            string CommandString = "SELECT DISTINCT " + Select + " FROM " + "kitbox_database.`commande`" + " WHERE " + WhereName + "='" + WhereValue + "'";
            MySql.Data.MySqlClient.MySqlCommand Command;
            Command = new MySql.Data.MySqlClient.MySqlCommand(CommandString, connection);
            MySql.Data.MySqlClient.MySqlDataReader Reader;
            Reader = Command.ExecuteReader();
        ...
        public static String Return2(string Select, string WhereName, string WhereValue)
        {
            string connectionString = "SERVER=127.0.0.1; DATABASE=kitbox_database; UID=root; PASSWORD=";
            MySqlConnection connection;
            connection = new MySql.Data.MySqlClient.MySqlConnection(connectionString);
        ...
        public static void Update(string Set, string Where)
        {
            ...
            string CommandString = "update kitbox_database.kitbox set Enstock='" + Set + "' where CodeBarre='" + Where + "';";
